# 🚀 Auto Installer X-ray & Zivpn (Platinum Complete V.6.6)
...
### Core Protocols
* ✅ X-ray Vmess (WS TLS / Non-TLS)
* ✅ X-ray Vless (WS TLS / Non-TLS)
* ✅ X-ray Trojan (WS TLS)
* ✅ Zivpn UDP (Game & Sosmed)

### Fitur Canggih
* ✅ **Trial Generator:** Membuat akun trial hitungan Menit atau Jam.
* ✅ **Auto Timezone:** Otomatis deteksi lokasi VPS & set jam WIB/WITA/WIT.
* ✅ **Auto Delete:** Hapus akun expired & trial secara otomatis & presisi.
* ✅ **Anti-Multi Login:** (Optional/Included in core logic).

### System Optimization
* ✅ Auto Enable TCP BBR (Google).
* ✅ Auto Swap RAM 2GB.
* ✅ IPtables & Netfilter Optimization.

---

# ⚙️ Detail Port & Protokol
