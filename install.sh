        ...
        async function apiCall(url, bodyData) {
            try {
                ...
                try {
                    ...
                    return {success: false, message: "Terjadi gangguan server sementara. Silakan coba lagi."};
                }
            } catch(e) {
                return {success: false, message: "Koneksi terputus. Pastikan internet Anda lancar."};
            }
        }
